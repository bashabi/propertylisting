...
<body class="bg-gray-100">
    ...
    <header class="bg-blue-900 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-3xl font-semibold">
                <a href="index.html">Proerty Listing</a>
            </h1>
            <nav class="space-x-4">
                ...
                <a href="post-job.html" class="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded hover:shadow-md transition duration-300"><i class="fa fa-edit"></i> Post a Property</a>
            </nav>
        </div>
    </header>
    ...
    <section class="showcase relative bg-cover bg-center bg-no-repeat h-72 flex items-center">
        ...
        <div class="container mx-auto text-center z-10">
            <h2 class="text-4xl text-white font-bold mb-4">Find Your Dream Property</h2>
    ...
    <section class="bg-blue-900 text-white py-6 text-center">
        <div class="container mx-auto">
            <h2 class="text-3xl font-semibold">Explore Your Property Potential</h2>
