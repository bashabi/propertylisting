...
<!-- Post a property Form Box -->
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        <h2 class="text-4xl text-center font-bold mb-4">Create A Property Listing</h2>
        ...
        <form method="POST" action="/listings">
            ...
            <div class="mb-4">
                <input type="text" name="title" placeholder="Title" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing['title'] ?? '' ?>" />
            </div>
            <div class="mb-4">
                <textarea name="description" placeholder="Description" class="w-full px-4 py-2 border rounded focus:outline-none"><?= $listing['description'] ?? '' ?></textarea>
            </div>
            <div class="mb-4">
                <input type="text" name="price" placeholder="price" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing['price'] ?? '' ?>" />
            </div>
            <div class="mb-4">
                <input type="text" name="type" placeholder="type" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing['type'] ?? '' ?>" />
            </div>
